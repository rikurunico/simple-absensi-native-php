            ...
            <div class="card-body">
                ...
                <div class="step-indicator">
                    <?php foreach ($steps as $step_num => $step_name): ?>
                        <div class="step <?= $step_num < $current_step ? 'completed' : ($step_num === $current_step ? 'active' : '') ?>">
                ...
                <?php if ($current_step === 1): ?>
                    ...
                    <form method="POST" action="">
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" id="db_host" name="db_host" value="<?= $_POST['db_host'] ?? 'localhost' ?>" required>
                            <div class="form-text">Usually 'localhost' or '127.0.0.1'</div>
                        </div>
                        
                        <div class="mb-3">
                            <label for="db_name" class="form-label">Database Name</label>
                            <input type="text" class="form-control" id="db_name" name="db_name" value="<?= $_POST['db_name'] ?? 'absensi_db' ?>" required>
                            <div class="form-text">If the database doesn't exist, we'll create it for you</div>
                        </div>
                        
                        <div class="mb-3">
                            <label for="db_user" class="form-label">Database User</label>
                            <input type="text" class="form-control" id="db_user" name="db_user" value="<?= $_POST['db_user'] ?? 'root' ?>" required>
                        </div>
                        
                        <div class="mb-3">
                            <label for="db_pass" class="form-label">Database Password</label>
                            <input type="password" class="form-control" id="db_pass" name="db_pass" value="<?= $_POST['db_pass'] ?? '' ?>">
                ...
                <?php elseif ($current_step === 2): ?>
                    ...
                    <form method="POST" action="">
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" id="nama_lengkap" name="nama_lengkap" value="<?= $_POST['nama_lengkap'] ?? 'Administrator' ?>" required>
                        </div>
                        
                        <div class="mb-3">
                            <label for="username" class="form-label">Username</label>
                            <input type="text" class="form-control" id="username" name="username" value="<?= $_POST['username'] ?? 'admin' ?>" required>
                        </div>
                ...
                <?php elseif ($current_step === 3): ?>
                    <div class="text-center py-4">
                        ...
                        <div class="alert alert-warning mt-4">
                            ...
                            <strong>Important:</strong> For security reasons, please delete or rename the <code>install.php</code> file.
                        </div>
